import 'package:Respawnd/bloc/search/bloc.dart';
import 'package:Respawnd/models/user.dart';
import 'package:Respawnd/repositories/searchRepository.dart';
import 'package:Respawnd/ui/widgets/iconWidget.dart';
import 'package:Respawnd/ui/widgets/profile.dart';
import 'package:Respawnd/ui/widgets/userGender.dart';
            ...
            return Center(
              child: Text(
                ...
                style: GoogleFonts.inter(
                  ...
                  textStyle:
                      TextStyle(fontSize: size.width * 0.09, color: colorRed),
                ),
              ),
            );
          } else
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        ...
                        //     Colors.yellow),
                        iconWidget(Icons.close_rounded, () {
                          _searchBloc
